...
Grid_45 = Cos(45*Radtodeg)*Grid_Radius
Grid_67 = Cos(67.5*Radtodeg)*Grid_Radius
Grid_22 = Cos(22.5*Radtodeg)*Grid_Radius
...
Do 
    ...
    If Grid_State = 1 Then
        ...
        Line (Body(0).X+MidX-Grid_45, Body(0).Y+MidY-Grid_45)-(Body(0).X+MidX+(Grid_45*Grid_1), Body(0).Y+MidY+(Grid_45*Grid_1)), RGB(4, 24, 4)
        Line (Body(0).X+MidX-Grid_45, Body(0).Y+MidY+Grid_45)-(Body(0).X+MidX+(Grid_45*Grid_1), Body(0).Y+MidY-(Grid_45*Grid_1)), RGB(4, 24, 4)
        
        Line (Body(0).X+MidX+Grid_67, Body(0).Y+MidY+Grid_22)-(Body(0).X+MidX-Grid_67, Body(0).Y+MidY-Grid_22), RGB(4, 24, 4)
        Line (Body(0).X+MidX-Grid_67, Body(0).Y+MidY+Grid_22)-(Body(0).X+MidX+Grid_67, Body(0).Y+MidY-Grid_22), RGB(4, 24, 4)
        Line (Body(0).X+MidX+Grid_22, Body(0).Y+MidY+Grid_67)-(Body(0).X+MidX-Grid_22, Body(0).Y+MidY-Grid_67), RGB(4, 24, 4)
        Line (Body(0).X+MidX-Grid_22, Body(0).Y+MidY+Grid_67)-(Body(0).X+MidX+Grid_22, Body(0).Y+MidY-Grid_67), RGB(4, 24, 4)
    End If
