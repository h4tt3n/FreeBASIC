...
Do 
    ...
    If Timer >= last_screen_update + screen_update Then 
        ...
        If Ship(0).State = 1 Then
            ...
            If multikey (75) then 
                Ship(0).Direction += 8: If Ship(0).Direction >= 360 then Ship(0).Direction -= 360
                Rec (8, 180-Ship(0).Direction)
                Ship(0).Xtrac = Xrec
                Ship(0).Ytrac = Yrec
            End If
            If multikey (77) then 
                Ship(0).Direction -= 8: If Ship(0).Direction < 0 then Ship(0).Direction += 360
                Rec (8, 180-Ship(0).Direction)
                Ship(0).Xtrac = Xrec
                Ship(0).Ytrac = Yrec
            End If
            ...
            If multikey (72) then
                If Ship(0).Fuel_Mass >= 0.01 then
                    Ship(0).Xvec += 10*(Cos(Ship(0).Direction*Radtodeg)/Ship(0).Mass)
                    Ship(0).Yvec += 10*(Sin(-Ship(0).Direction*Radtodeg)/Ship(0).Mass)
