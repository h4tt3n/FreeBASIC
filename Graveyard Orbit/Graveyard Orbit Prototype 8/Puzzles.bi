...
Sub GameType.Puzzle6()
	...
	'' wheels
	Dim As WheelType Ptr W1 = CreateWheel( Vec2( 300.0, 500.0 ), 70.0 )
	Dim As WheelType Ptr W2 = CreateWheel( Vec2( 400.0, 500.0 ), 70.0 )
	Dim As WheelType Ptr W3 = CreateWheel( Vec2( 500.0, 500.0 ), 70.0 )
	Dim As WheelType Ptr W4 = CreateWheel( Vec2( 600.0, 500.0 ), 70.0 )
	
	''
	Dim As RevoluteJointType Ptr J1 = CreateRevoluteJoint( Vec2( 300, 500 ), @(B2->AngularState), @(W1->AngularState) )
	Dim As RevoluteJointType Ptr J2 = CreateRevoluteJoint( Vec2( 400, 500 ), @(B2->AngularState), @(W2->AngularState) )
	Dim As RevoluteJointType Ptr J3 = CreateRevoluteJoint( Vec2( 500, 500 ), @(B2->AngularState), @(W3->AngularState) )
	Dim As RevoluteJointType Ptr J4 = CreateRevoluteJoint( Vec2( 600, 500 ), @(B2->AngularState), @(W4->AngularState) )
	
	CreateAngularJoint( @(W1->AngularState), @(W2->AngularState) )
	CreateAngularJoint( @(W2->AngularState), @(W3->AngularState) )
	CreateAngularJoint( @(W3->AngularState), @(W4->AngularState) )
	
	'Dim As GearJointType Ptr G1 = CreateGearJoint( @(W1->AngularState), @(W2->AngularState), 10.0, 10.0 )
	'Dim As GearJointType Ptr G2 = CreateGearJoint( @(W2->AngularState), @(W3->AngularState), 10.0, 10.0 )
	'Dim As GearJointType Ptr G3 = CreateGearJoint( @(W3->AngularState), @(W4->AngularState), 10.0, 10.0 )
	
	''
	W2->AngularState.angular_impulse = -2.0
...
Sub GameType.Puzzle8()
	...
	'' create particles
	Dim As RoxelType Ptr RP1 = CreateRoxel( Vec2( 0.25 * SCREEN_WIDTH, 0.25 * SCREEN_HEIGHT ), 1.0 + Rnd() * 32.0, 0.0 )
	Dim As RoxelType Ptr RP2 = CreateRoxel( Vec2( 0.75 * SCREEN_WIDTH, 0.25 * SCREEN_HEIGHT ), 1.0 + Rnd() * 32.0, 0.0 )
	Dim As RoxelType Ptr RP3 = CreateRoxel( Vec2( 0.25 * SCREEN_WIDTH, 0.75 * SCREEN_HEIGHT ), 1.0 + Rnd() * 32.0, 0.0 )
	Dim As RoxelType Ptr RP4 = CreateRoxel( Vec2( 0.75 * SCREEN_WIDTH, 0.75 * SCREEN_HEIGHT ), 1.0 + Rnd() * 32.0, 0.0 )
