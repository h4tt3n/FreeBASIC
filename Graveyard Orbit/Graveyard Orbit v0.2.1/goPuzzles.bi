...
Sub Game.Puzzle1()
	...
	Dim As Planet Ptr P1 = CreatePlanet( 1E8, 0.0, 500.0)

	P1->SetColour( RGB( 80, 128, 64 ) )

	Dim As RigidBody Ptr A1 = CreateAsteroid( 1E8, 256, Vec2( 1000.0, 500.0 ) )
...
Sub Game.Puzzle2()
	...
	''
	Dim As KeplerOrbit Ptr K1 = GameWorld.CreateKeplerOrbit( P1, P2 )
	Dim As KeplerOrbit Ptr K2 = GameWorld.CreateKeplerOrbit( K1->GetLinearLink, P3 )
...
Sub Game.Puzzle3()
	...
	''
	K2->GetLinearLink->LowerFlag( IS_VISIBLE )
	K3->GetLinearLink->LowerFlag( IS_VISIBLE )
	K4->GetLinearLink->LowerFlag( IS_VISIBLE )
	K5->GetLinearLink->LowerFlag( IS_VISIBLE )
	K6->GetLinearLink->LowerFlag( IS_VISIBLE )
	K7->GetLinearLink->LowerFlag( IS_VISIBLE )
	K8->GetLinearLink->LowerFlag( IS_VISIBLE )
...
Sub Game.Puzzle4()
	...
	Dim As KeplerOrbit Ptr K1 = GameWorld.CreateKeplerOrbit( P1, P2 )
	Dim As KeplerOrbit Ptr K2 = GameWorld.CreateKeplerOrbit( K1->GetLinearLink, P3 )
	Dim As KeplerOrbit Ptr K3 = GameWorld.CreateKeplerOrbit( K2->GetLinearLink, P4 )
...
Sub Game.Puzzle5()
	...
	Dim As KeplerOrbit Ptr K2 = GameWorld.CreateKeplerOrbit( K1->GetLinearLink, P3 )
	Dim As KeplerOrbit Ptr K3 = GameWorld.CreateKeplerOrbit( K2->GetLinearLink, P4 )
	Dim As KeplerOrbit Ptr K4 = GameWorld.CreateKeplerOrbit( K3->GetLinearLink, P5 )
	Dim As KeplerOrbit Ptr K5 = GameWorld.CreateKeplerOrbit( K4->GetLinearLink, P6 )
...
Sub Game.Puzzle6()
	...
	Dim As LinearSpring Ptr L1 = GameWorld.CreateLinearSpring( 0.01, 0.01, 0.5, *Ri1->LinearLinks_[1], *Ri3->LinearLinks_[3] )
	Dim As LinearSpring Ptr L2 = GameWorld.CreateLinearSpring( 0.01, 0.01, 0.5, *Ri2->LinearLinks_[3], *Ri3->LinearLinks_[1] )
	
	GameWorld.CreateAngularSpring( 0.01, 0.01, 0.5, L1->GetLinearLink, *Ri1->LinearLinks_[1] )
	GameWorld.CreateAngularSpring( 0.01, 0.01, 0.5, L2->GetLinearLink, *Ri2->LinearLinks_[3] )
	GameWorld.CreateAngularSpring( 0.01, 0.01, 0.5, L1->GetLinearLink, *Ri3->LinearLinks_[3] )
	GameWorld.CreateAngularSpring( 0.01, 0.01, 0.5, L2->GetLinearLink, *Ri3->LinearLinks_[1] )
...
Sub Game.Puzzle8()
	...
	Dim As KeplerOrbit Ptr K1 = GameWorld.CreateKeplerOrbit( P1, P2 )
	Dim As KeplerOrbit Ptr K2 = GameWorld.CreateKeplerOrbit( K1->GetLinearLink, P3 )
	Dim As KeplerOrbit Ptr K3 = GameWorld.CreateKeplerOrbit( K1->GetLinearLink, P4 )
	Dim As KeplerOrbit Ptr K4 = GameWorld.CreateKeplerOrbit( K1->GetLinearLink, P5 )
	...
	Dim As Body Ptr Asteroids2 = CreateAsteroidBelt( K1->GetLinearLink, 100, Vec2( 1E2, 1E4 ), Vec2( 0.0, 0.0 ), Vec2( 60000.0, 68000.0 ), Vec2( -0.1 * TWO_PI, -0.1 * TWO_PI ), CW )
...
Sub Game.Puzzle9()
	...
	'' Kepler Orbits
	Dim As KeplerOrbit Ptr K1 = GameWorld.CreateKeplerOrbit( P1, P2 )
	Dim As KeplerOrbit K2 = KeplerOrbit( K1->GetLinearLink, R1 )
