...
''   Version 1.2.0, May 2016, Michael "h4tt3n" Nissen
''   
''   Function syntax:
''   
...
Type Vec2
  ...
  Declare Const Function Perp            () As Vec2
  ...
  Declare Const Function Rotate          ( ByRef B As Const Vec2   ) As Vec2
...
Declare Function Perp              ( ByRef A As Const Vec2 ) As Vec2
...
Declare Function Rotate   OverLoad ( ByRef A As Const Vec2  , ByRef B As Const Vec2   ) As Vec2
...
Function Vec2.Rotate( ByRef B As Const Vec2 ) As Vec2
	
	Return Vec2( This.Dot( B ), This.PerpDot( B ) )
...
Function Perp( ByRef A As Const Vec2 ) As Vec2
...
Function Rotate( ByRef A As Const Vec2, ByRef B As Const Vec2 ) As Vec2
