...
Type LinearLinkType Extends LinearStateType
	...
	Dim As Single collision_damping
	Dim As Single collision_stiffnes
	Dim As Single collision_warmstart
	
	Dim As Single dynamic_friction
	Dim As Single static_friction
