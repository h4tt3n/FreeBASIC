...
Sub GameType.Puzzle5()
	...
	W6->AngularState.angular_impulse = 10.0
...
Sub GameType.Puzzle6()
	...
	'' wheels
	Dim As WheelType Ptr W4 = CreateWheel( Vec2( 675.0, 500.0 ), 100.0 )
	Dim As WheelType Ptr W3 = CreateWheel( Vec2( 550.0, 500.0 ), 100.0 )
	Dim As WheelType Ptr W2 = CreateWheel( Vec2( 425.0, 500.0 ), 100.0 )
	...
	''
	Dim As GearConstraintType Ptr G1 = CreateGearConstraint( @(W1->AngularState), @(W2->AngularState), -10.0, 2.5 )
	Dim As GearConstraintType Ptr G2 = CreateGearConstraint( @(W2->AngularState), @(W3->AngularState), -10.0, 2.5 )
	Dim As GearConstraintType Ptr G3 = CreateGearConstraint( @(W3->AngularState), @(W4->AngularState), -10.0, 2.5 )
	...
	'CreateGearConstraint( @(W1->AngularState), @(W4->AngularState), -64.0 )
	...
	B2->AngularState.addImpulse( Vec2( 5.0, 0.0 ) )
