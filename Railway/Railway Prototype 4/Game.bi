...
Sub GameType.UpdateInput()
	...
	Dim As Integer m_screen_x =  (  mouse_x - SCREEN_WIDTH  ) * GameCamera.Zoom + GameCamera.position.x
	Dim As Integer m_screen_y =  ( -mouse_y + SCREEN_HEIGHT ) * GameCamera.Zoom + GameCamera.position.y 
