...
Type LinearSpringType
	...
	Declare Constructor( ByVal _linear1 As LinearStateType Ptr, _
	                     ByVal _linear2 As LinearStateType Ptr )
...
Constructor LinearSpringType( ByVal _linear1 As LinearStateType Ptr, _
	                           ByVal _linear2 As LinearStateType Ptr )
	
	ResetAllVars()
	
	LinearLink.a = _linear1
	LinearLink.b = _linear2
	
	rest_distance = ( LinearLink.b->position - LinearLink.a->position ).length()

	LinearLink.mass = LinearLink.a->mass + LinearLink.b->mass
		
	LinearLink.ComputeInvMass()
		
	LinearLink.ComputeReducedMass()
...
Sub LinearSpringType.ResetAllVars()
