...
''	test # 08 , rectangle collision detection
''
''	press "esc" to quit
''	
''	Reference:
...
WindowTitle "Rigid body dynamics with SAT collision # 08"
Color RGB(64, 255, 64), RGB(0, 0, 0)
    ...
    For A As integ = 0 To NumBoxes-1
    	With box[A]
    		...
    		For B As integ = 0 To .Num_Vertices-1
    			...
    			Line(pnt1.x, pnt1.y)-(pnt2.x, pnt2.y), RGB(255, 255, 255)
    			
    			'Draw String (pnt1.x + 4, pnt1.y + 4), Str(B)
