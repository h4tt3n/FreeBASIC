...
Const As Single  LOCAL_DAMPING_COEFF    = 0.3	  '' 0.4                                 ''
...
Sub SimulationType.ComputeReusableData()
	...
	For N As ParticlePairType Ptr = @fluid.particlePairs( 1 ) To @fluid.particlePairs( fluid.numParticlePairs_ )
		...
		Dim As Single local_damping_impulse   = - N->nOverDistance_.dot( N->particleB_->velocity_ - N->particleA_->velocity_ ) * fluid.localDampingCoefficient_ 
