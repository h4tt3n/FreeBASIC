...
Const As Integer  ITERATIONS            = 12                                       ''

Const As Single  PARTICLE_RADIUS        = 15.0                                          '' particle radius
Const As Single  PARTICLE_DIAMETER      = PARTICLE_RADIUS * 2.0                        ''

Const As Single  LOCAL_PRESSURE_COEFF   = 0.0001  '' 0.0001                                ''                              ''
Const As Single  GLOBAL_PRESSURE_COEFF  = 0.02	  '' 0.02                                  ''
Const As Single  LOCAL_DAMPING_COEFF    = 2.0	  '' 0.8                                 ''

Const As Single  REST_DISTANCE          = 28.0    '' 30                                  ''

Const As Single  REST_DENSITY           = 5000.0 '12000                               '' rest pressure
...
Const As Integer MAX_PAIRS_LOCAL        = 24                                           '' max number of neighbors per particles
