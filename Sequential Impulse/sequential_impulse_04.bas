...
''
''  Version 4, september 2015, Michael "h4tt3n" Nissen
''
...
''   Global constants
Const As Single  c_stiffness    = 0.5               ''  spring stiffness coefficient    [0, 1]
Const As Single  c_damping      = 1.0               ''  spring damping coefficient      [0, 1]
Const As Single  c_corrective   = 0.5                ''  corrective impulse coefficient  [0, 1]
Const As Single  c_warmstart    = 0.5               ''  warm starting coefficient       [0, 1]
...
Sub SimulationType.ComputeVelocity()
...
Sub SimulationType.ComputePosition()
