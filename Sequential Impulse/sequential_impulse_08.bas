...
''
''  Version 5, september 2015, Michael "h4tt3n" Nissen
''
...
''   Global constants
Const As Double  c_stiffness    = 1.0               ''  spring stiffness coefficient    [0, 1]
Const As Double  c_damping      = 1.0               ''  spring damping coefficient      [0, 1]
Const As Double  c_corrective   = 1.0                ''  corrective impulse coefficient  [0, 1]
...
Const As Double  gravity        = 0.0              ''  gravity
...
Const As Integer num_iterations = 4                 ''  number of impulse iterationsations per state update
Const As Integer num_particles  = 24                ''  number of particles
...
Sub SimulationType.ApplyWarmStarting()
	...
	For S As SpringType Ptr = SpringLo To SpringHi Step 1
		...
		If ( projected_impulse < 0.0 ) Then
			...
			S->particle_a->impulse -= c_warmstart * projected_impulse * S->n * S->particle_a->inverse_mass
			S->particle_b->impulse += c_warmstart * projected_impulse * S->n * S->particle_b->inverse_mass
