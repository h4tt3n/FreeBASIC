...
''
''  Version 0.26, August 2017, Michael "h4tt3n" Nissen
''
...
Sub SimulationType.Demo2()
	...
	'For i As integer = 1 To num_Particles - 2
	'	
	'	Dim As particletype Ptr P = @particle( i )
	'	
	'	P->position = 0.5 * Vec2( screen_wid, screen_hgt ) + Vec2().RandomizeSquare(100000)
	'	
	'Next
