...
''
''  Version 0.52, September 2018, Michael "h4tt3n" Nissen
''
...
Const As Single  gravity            = 0'100.0 * DT        ''  gravity
...
Sub SimulationType.Demo2()
	...
	Dim As Integer num_Particles       = 108
	Dim As Integer num_Springs         = 107
	...
	'	
	'	P->position = 0.5 * Vec2( screen_wid, screen_hgt ) + Vec2().RandomizeSquare(1000)
	'	'P->velocity = Vec2().RandomizeSquare(1000)
	'	
	'Next
