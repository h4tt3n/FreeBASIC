...
function DegSub (byval deg1 as Single, byval deg2 as Single) As Integer
    Deg = deg1 - deg2
...
function DegAdd (byval deg1 as Single, byval deg2 as Single) As Integer
    Deg = deg1 + deg2
    If Deg < 0 Then Deg += Twopi
    If Deg >= Twopi Then Deg -= Twopi
    Return Deg
