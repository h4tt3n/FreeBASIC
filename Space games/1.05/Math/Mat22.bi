...
Type Mat22
   ...
   Declare Operator *=  ( ByVal A As Const Single )
	...
	''
	Declare Const Function Absolute    () As Mat22
...
''
Declare Function Absolute OverLoad ( ByRef A As Const Mat22 ) As Mat22
...
''
Function Mat22.Absolute() As Mat22
	
	Return Mat22( This.C1.Absolute(), This.C2.Absolute() )
...
Function Mat22.Inverse() As Mat22
   ...
   'Dim As Single a, b, c, d
	...
	'
	'det = IIf ( det = 0.0f , 0.0f , 1.0f / det )
	'
	'M.c1.x =  det * d : M.c2.x = -det * b
	'M.c1.y = -det * c : M.c2.y =  det * a
...
''
Function Absolute( ByRef A As Const Mat22 ) As Mat22
