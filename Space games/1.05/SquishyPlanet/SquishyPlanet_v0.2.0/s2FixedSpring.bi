...
''   Unlike the LinearSpring, the FixedSpring cannot rotate freely, but 
...
Sub FixedSpring.ApplyCorrectiveImpulse()
	...
	Dim As Vec2 corrective_impulse = -Corrective_ * impulse_error
...
Sub FixedSpring.computeRestImpulse()
	...
	RestImpulse_ = -( Stiffnes_ * INV_DT * distance_error + Damping_ * velocity_error ) * ReducedMass_
...
'' Get
Function FixedSpring.Corrective() As Single
...
'' Set
Sub FixedSpring.Corrective ( ByVal c As Single )
