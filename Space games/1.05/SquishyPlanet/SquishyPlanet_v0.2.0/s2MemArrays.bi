...
''
Type AnguliteSpringArray
	
	Public:
	
	Declare Constructor()
	Declare Constructor( ByRef P As AnguliteSpringArray )
	
	Declare Destructor()
	
	Declare Operator Let( ByRef P As AnguliteSpringArray )
	Declare Operator [] ( ByVal i as Integer ) As AnguliteSpring Ptr
	
	Declare Function size     () As Integer
	Declare Function capacity () As Integer
	Declare Function back     () As AnguliteSpring Ptr
	Declare Function front    () As AnguliteSpring Ptr
	Declare Function push_back( ByRef P As AnguliteSpring ) As AnguliteSpring Ptr
	...
	As Integer size_            '' number of elements in use
	As Integer capacity_        '' number of Reserved elements
	As AnguliteSpring Ptr back_  '' Ptr to last elemet
	As AnguliteSpring Ptr front_ '' Ptr to first element
	As AnguliteSpring Ptr index_ '' array index
...
'' Constructors
Constructor AnguliteSpringArray()
	
	Clear()
	
End Constructor

Constructor AnguliteSpringArray( ByRef P As AnguliteSpringArray )
...
'' Destructor
Destructor AnguliteSpringArray()
...
'' Operators
Operator AnguliteSpringArray.Let( ByRef P As AnguliteSpringArray )
	...
	For I As AnguliteSpring Ptr = P.Front To P.Back
...
Operator AnguliteSpringArray.[]( ByVal i as Integer ) As AnguliteSpring Ptr
...
'' Functions
Function AnguliteSpringArray.push_back( ByRef P As AnguliteSpring ) As AnguliteSpring Ptr
...
Function AnguliteSpringArray.size() As Integer
	
	Return Size_
	
End Function

Function AnguliteSpringArray.Capacity() As Integer
	
	Return Capacity_
	
End Function

Function AnguliteSpringArray.Back() As AnguliteSpring Ptr
	
	Return Back_
	
End Function

Function AnguliteSpringArray.Front() As AnguliteSpring Ptr
...
''
Sub AnguliteSpringArray.Reserve( ByVal C As Integer )
	...
	If ( C > 0 ) Then
		...
		Index_ = New AnguliteSpring[ Capacity_ ]
