...
''   (point masses, springs) they are composed of.
...
''   from simple objects directly, any simple object can be part of more than 
''   one complex objects at the same time, thereby making it possible to link any 
