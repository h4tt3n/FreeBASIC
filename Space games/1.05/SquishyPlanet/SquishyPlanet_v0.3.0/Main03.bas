...
P1->Position( Vec2( GameScreen.GetWidth, GameScreen.GetHeight ) * 0.5 + Vec2().RandomizeSquare( 1200 ) )
P2->Position( Vec2( GameScreen.GetWidth, GameScreen.GetHeight ) * 0.5 + Vec2().RandomizeSquare( 1200 ) )
P3->Position( Vec2( GameScreen.GetWidth, GameScreen.GetHeight ) * 0.5 + Vec2().RandomizeSquare( 1200 ) )
P4->Position( Vec2( GameScreen.GetWidth, GameScreen.GetHeight ) * 0.5 + Vec2().RandomizeSquare( 1200 ) )
...
Do
	...
	If MultiKey( fb.SC_UP )   Then S3->RestLength( S3->RestLength + 10.0 )
	If MultiKey( fb.SC_DOWN ) Then S3->RestLength( S3->RestLength - 10.0 )
